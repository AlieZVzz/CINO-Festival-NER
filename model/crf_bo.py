...
bo_dict = np.load('../model/fasttext_bo/bo_wordsDict.npy', allow_pickle=True)
bo_vector = np.load('../model/fasttext_bo/bo_wordVectors.npy', allow_pickle=True)
...
class bo_Bert_BiLSTM_CRF(nn.Module):
    def __init__(self, tag_to_ix, hidden_dim=1068):
        super(bo_Bert_BiLSTM_CRF, self).__init__()
